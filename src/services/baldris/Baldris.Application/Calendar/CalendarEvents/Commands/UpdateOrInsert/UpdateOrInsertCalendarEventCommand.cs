...
{
    public class UpdateOrInsertCalendarEventCommand : IRequest<CalendarEventDto>, IHaveCustomMapping
    {
        ...
        {
            configuration.CreateMap<UpdateOrInsertCalendarEventCommand, CalendarEvent>()
                .ForMember(target => target.Id, opt => opt.MapFrom(source => source.Id ?? Guid.Empty));
            configuration.CreateMap<UpdateOrInsertCalendarEventCommand, UpdateCalendarEventCommand>().ReverseMap();
            configuration.CreateMap<UpdateOrInsertCalendarEventCommand, CreateCalendarEventCommand>().ReverseMap();
        }
    }
}
