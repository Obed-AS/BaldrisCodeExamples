...
{
    internal class BookingAutoTasksHandler : INotificationHandler<EntityCreatedNotification<Booking>>,
        ...
        INotificationHandler<EntityDeletedNotification<Booking>>
    {
        ...
        public BookingAutoTasksHandler(IBaldrisDbContextFactory dbContextFactory, ITenantService tenantService, IMediator mediator)
        {
