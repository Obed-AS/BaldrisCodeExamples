...
namespace Baldris.Application.Calendar.Bookings.NotificationHandlers.AttachedAutos
{
    internal class BookingAutoProductsHandler : INotificationHandler<EntityCreatedNotification<Booking>>,
        INotificationHandler<EntityUpdatedNotification<Booking>>,
        INotificationHandler<EntityDeletedNotification<Booking>>
    {
        private readonly IBaldrisDbContextFactory _dbContextFactory;
        private readonly ITenantService _tenantService;
        private readonly IMediator _mediator;

        public BookingAutoProductsHandler(IBaldrisDbContextFactory dbContextFactory, ITenantService tenantService, IMediator mediator)
        {
        ...
        public async Task Handle(EntityCreatedNotification<Booking> notification,
        ...
        public async Task Handle(EntityUpdatedNotification<Booking> notification,
            CancellationToken cancellationToken)
        {
            if (notification.GoverningId.HasValue)
            {
        ...
        public async Task Handle(EntityDeletedNotification<Booking> notification,
            CancellationToken cancellationToken)
        {
            if (notification.GoverningId.HasValue)
            {
