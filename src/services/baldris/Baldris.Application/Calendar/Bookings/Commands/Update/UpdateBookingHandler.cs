...
namespace Baldris.Application.Calendar.Bookings.Commands.Update
{
    internal class UpdateBookingHandler : IRequestHandler<UpdateBookingCommand, int>
    {
        ...
        public UpdateBookingHandler(IBaldrisDbContextFactory dbContextFactory, IMapper mapper,
        ...
        public async Task<int> Handle(UpdateBookingCommand request, CancellationToken cancellationToken)
        {
            ...
            var entity = _mapper.Map<UpdateBookingCommand, Booking>(request);
            ...
            // Send Notification
            await _mediator.Publish(new EntityUpdatedNotification<Booking>
