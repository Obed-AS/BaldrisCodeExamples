...
{
    internal class CreateBookingHandler : IRequestHandler<CreateBookingCommand, BookingDto>
    {
        ...
        public CreateBookingHandler(IBaldrisDbContextFactory dbContextFactory, IMapper mapper,
        ...
        public async Task<BookingDto> Handle(CreateBookingCommand request, CancellationToken cancellationToken)
        {
            ...
            var entity = _mapper.Map<CreateBookingCommand, Booking>(request);
            ...
            // Send Notification
            await _mediator.Publish(new EntityCreatedNotification<Booking>
                { CreatedId = entity.Id, CreatedValue = entity, UserId = userId }, cancellationToken);

            // Get newly inserted entity
            var insertedEntity = await dbContext.Bookings
