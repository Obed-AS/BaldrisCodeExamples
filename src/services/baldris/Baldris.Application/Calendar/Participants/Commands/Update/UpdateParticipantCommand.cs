...
namespace Baldris.Application.Calendar.Participants.Commands.Update
{
    public class UpdateParticipantCommand : IRequest<int>, IHaveCustomMapping
    {
        ...
        {
            configuration.CreateMap<UpdateParticipantCommand, Participant>();
        }
    }
}
