...
namespace Baldris.Application.Calendar.Ceremonies.Commands.Update
{
    public class UpdateCeremonyCommand : IRequest<int>, IHaveCustomMapping
    {
        ...
        {
            configuration.CreateMap<UpdateCeremonyCommand, Ceremony>();
        }
    }
}
