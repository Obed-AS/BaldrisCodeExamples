...
namespace Baldris.Application.Calendar.Transports.NotificationHandlers.AttachedAutos
{
    internal class TransportAutoProductsHandler : INotificationHandler<EntityCreatedNotification<Transport>>,
        INotificationHandler<EntityUpdatedNotification<Transport>>,
        INotificationHandler<EntityDeletedNotification<Transport>>
    {
        private readonly IBaldrisDbContextFactory _dbContextFactory;
        private readonly ITenantService _tenantService;
        private readonly IMediator _mediator;

        public TransportAutoProductsHandler(IBaldrisDbContextFactory dbContextFactory, ITenantService tenantService, IMediator mediator)
        {
        ...
        public async Task Handle(EntityCreatedNotification<Transport> notification,
        ...
        public async Task Handle(EntityUpdatedNotification<Transport> notification,
            CancellationToken cancellationToken)
        {
            if (notification.GoverningId.HasValue)
            {
        ...
        public async Task Handle(EntityDeletedNotification<Transport> notification,
            CancellationToken cancellationToken)
        {
            if (notification.GoverningId.HasValue)
            {
