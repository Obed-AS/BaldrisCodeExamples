...
{
    internal class TransportAutoTasksHandler : INotificationHandler<EntityCreatedNotification<Transport>>,
        ...
        INotificationHandler<EntityDeletedNotification<Transport>>
    {
        ...
        public TransportAutoTasksHandler(IBaldrisDbContextFactory dbContextFactory, ITenantService tenantService, IMediator mediator)
        {
