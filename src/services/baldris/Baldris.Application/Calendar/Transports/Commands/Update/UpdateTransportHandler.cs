...
namespace Baldris.Application.Calendar.Transports.Commands.Update
{
    internal class UpdateTransportHandler : IRequestHandler<UpdateTransportCommand, int>
    {
        ...
        public UpdateTransportHandler(IBaldrisDbContextFactory dbContextFactory, IMapper mapper,
        ...
        public async Task<int> Handle(UpdateTransportCommand request, CancellationToken cancellationToken)
        {
            ...
            var entity = _mapper.Map<UpdateTransportCommand, Transport>(request);
            ...
            {
                throw new NotFoundException(nameof(Transport), request.Id);
            }
