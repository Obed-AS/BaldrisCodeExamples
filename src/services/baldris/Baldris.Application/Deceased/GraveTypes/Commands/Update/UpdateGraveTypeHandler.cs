...
{
    internal class UpdateGraveTypeHandler : IRequestHandler<UpdateGraveTypeCommand, int>
    {
        ...
        public UpdateGraveTypeHandler(IBaldrisDbContextFactory dbContextFactory, IMapper mapper,
        ...
        public async Task<int> Handle(UpdateGraveTypeCommand request, CancellationToken cancellationToken)
        {
            var dbContext = _dbContextFactory.GetDbContext(await _tenantService.GetCurrentTenantAsync());

            var entity = _mapper.Map<UpdateGraveTypeCommand, GraveType>(request);
            ...
            {
                throw new NotFoundException(nameof(GraveType), request.Id);
            }
